...
#[component]
pub fn AllStoredPasswordDeletionDialog(
    ...
    rsx! {
        crate::components::globals::dialogs::BaseModal {
            ...
            // Titolo
            h3 { class: "font-bold text-lg mb-2", "Delete ALL" }

            // Messaggio di conferma
            p { class: "py-4",
                "Are you sure you want to delete ALL your stored passwords?"
                strong { "This action cannot be undone." }
            }

            p { class: "text-error-600 py-2",
                strong { "Attention: " }
