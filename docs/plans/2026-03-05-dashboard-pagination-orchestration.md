...
|------|------------|-------|----------|--------|
| 1-database-layer | [task-1-database-layer.md](./pagination-tasks/task-1-database-layer.md) | 🔵 DA FARE | - | - |
| 2-pagination-state | [task-2-pagination-state.md](./pagination-tasks/task-2-pagination-state.md) | 🔵 DA FARE | - | - |
