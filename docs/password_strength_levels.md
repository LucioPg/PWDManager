...
Il sistema di valutazione delle password assegna uno **score da 0 a 100** basato su più fattori, che viene poi
convertito in un livello di forza (`PasswordStrength`).
